<?php
    $this->setSiteTitle('Hirdetéskezelés');
    $this->start('body');
?>
<div class="container">
  ...
  <div class="product-container row" data-id="<?=$product->id?>">
    ...
    <div class="product-price col-md-2">Kikiáltási ár<p class="price"><?= $product->price ?> Ft</p>Aktuális ár<p class="actual_price"><?= ($product->actual_price != '' && $product->actual_price != null)?$product->actual_price : $product->price ?> Ft</p></div>
