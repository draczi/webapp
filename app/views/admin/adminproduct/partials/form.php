...
<form action="<?=$this->formAction?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="col-md-12 text-right">
      <a href="<?=PROOT?>adminproduct" class="btn btn-large btn-secondary">Mégse</a>
      <?= FH::submitTag('Termék feltöltés', ['class' => 'btn btn-large btn-primary','style' => 'background-color: #17a2b8; border: none;']) ?>
  </div>
</form>
