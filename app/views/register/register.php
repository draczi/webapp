...
<div class="regist-form col-md-8">
  <h3 class="text-center">Regisztráció</h3>
    <form action="" class="form" method="post">
      ...
      <div class="row">
          <?= FH::inputBlock('text','Város *', 'city', $this->newUser->city, ['class' => 'form-control'], ['class' => 'form-group col-md-6 '],$this->displayErrors); ?>
          <?= FH::inputBlock('text','Megye', 'state', $this->newUser->state, ['class' => 'form-control'], ['class' => 'form-group col-md-3 '], $this->displayErrors); ?>
      ...
      <div class="row">
          <?= FH::inputBlock('text','Adószám', 'tax_number', $this->newUser->tax_number, ['class' => 'form-control'], ['class' => 'form-group col-md-6 '],$this->displayErrors); ?>
          <?= FH::inputBlock('text','Őstermelői igazolvány', 'producer_number', $this->newUser->producer_number, ['class' => 'form-control'], ['class' => 'form-group col-md-6 '],$this->displayErrors); ?>
      </div>
      <?= FH::submitBlock('Regisztráció', ['class' => 'btn btn-primary btn-large btn-info', 'style' => "margin-top: 10px"], ['class' => 'text-right'],$this->displayErrors)?>
    </form>
</div>
</div>
<?php $this->end(); ?>
