<?php
   ...
   * Creates a database
   * @method createTable
   * @param  string       $database name of the db table
   * @return boolean
   */
  public function createDatabase($database) {
    ...
    $this->_printColor($res, "Creating Database " . $database);
    return $res;
  }
   ...
   * @return boolean
   */
  public function createTable($table, $id, $auto_inc=""){
  ...
  public function addSoftDelete($table){
    $this->addColumn($table,'deleted','tinyint', ['size' => 1]);
